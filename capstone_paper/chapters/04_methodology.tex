...
The implemented pipeline consists of four modular stages that transform a visual input into a validated drone formation compatible with Skybrush Studio. An overview of this workflow is shown in Figure~\ref{fig:pipeline}.
...
\begin{figure}[tbp]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[height=6cm]{figures/methodology/wabbit_formation.png}
        \vspace{0.5em}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[height=6cm]{figures/methodology/wabbit_farthest.png}
        \vspace{0.5em}
